...
- Stream endpoints (trades, candles, last-price, limits)
- Limit Monitor Management API
...
- **Limit Monitor Management**: Управление настройками мониторинга лимитов (`/api/limit-monitor`)
